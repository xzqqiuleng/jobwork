...
import 'dialog_filtarea.dart';
import 'item_jobfilt.dart';


class FiltCitysss extends StatefulWidget {
  @override
  _FiltCitysssState createState() => _FiltCitysssState();
}

class _FiltCitysssState extends State<FiltCitysss> {
  var _cityFilterData = CityFiltDtas.loadCityFilterData();
