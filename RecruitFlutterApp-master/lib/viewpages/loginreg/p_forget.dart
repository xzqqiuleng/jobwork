...
class PForget extends StatefulWidget{
  int type;
  PForget(this.type);
  @override
...
class _ForgetState extends State<PForget>{
  ...
  void setNewPd(){
    ...
    if(_newPdController.text.length <6 || _ConfirmPdController.text.length<6){
      ...
      PinPinReponse().forgetPd(_phoneController.text, _newPdController.text,widget.type).then((value) {
                              ...
                              children: <Widget>[
                                ...
                                Positioned(
                                    ...
                                    child: GestureDetector(
                                        child: VerCodeBtn(1,key:_codeSendKey),
                                        onTap: (){
