...
import 'package:recruit_app/viewpages/jobpages/jobcon/btn_collect.dart';
import 'package:recruit_app/viewpages/jobpages/jobcon/cust_check.dart';
import 'package:recruit_app/viewpages/jobpages/jobcon/model_compy.dart';
import 'package:recruit_app/viewpages/utils/util_scren.dart';



class EmpySeles extends StatefulWidget {
  final double height;
  final Color themeColor;
  final ValueChanged<Map> onSureButtonClick;

  EmpySeles({Key key,this.height,this.themeColor,this.onSureButtonClick}) :super(key:key);
  @override
  _EmpySelesState createState() => _EmpySelesState();
}

class _EmpySelesState extends State<EmpySeles> {
 ModelCompay typesModel = ModelCompay();
 Map<String,String>map = new Map();
 Future<void> fetchData() async {
    try {

      var responseStr = await rootBundle.loadString('mock/jl_types.json');
        ...
        children: <Widget>[
          new Container(
            ...
            child: new Column(
              ...
              children: <Widget>[
                new Text("学历7",style: new TextStyle(fontSize: 16.0,color: Colors.black)),
                new Container(
          ...
          new Container(
            ...
            child: new Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: <Widget>[
                new Text("性别",style: new TextStyle(fontSize: 16.0,color: Colors.black)),
                new Container(
                  margin: EdgeInsets.only(top: 15.0),
                  height: scaleHeight,
