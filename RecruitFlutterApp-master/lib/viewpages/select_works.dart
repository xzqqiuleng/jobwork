...
class SelectWorks extends StatefulWidget {
  final double height;
  final Color  themeColor;
  final String locationIcon;
  final ValueChanged<String> onValueChanged;

  SelectWorks({Key key,this.height,this.locationIcon = '', this.themeColor = Colors.grey,this.onValueChanged}): super(key:key);

  @override
  _SelectWorksState createState() => _SelectWorksState();
}

class _SelectWorksState extends State<SelectWorks> {
 List models = [];
 Map works=Map();
 int currentSelect = 0;
 bool isTap = false;
