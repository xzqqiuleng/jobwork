...
class MineDesc extends StatefulWidget {
  int type; //0,姓名 1，公司名称 2，工作职位 3.工作内容
  String mhint;
  MineDesc(this.type,{this.mhint});
  @override
  _MineDescState createState() => _MineDescState();
}

class _MineDescState extends State<MineDesc> {
  ...
  void _updete(String json){
    ...
    PinPinReponse().upDateJL(json).then((value) {
