...
class LibSbjobs extends StatefulWidget {

  String searchTxt;
  LibSbjobs({Key key,this.searchTxt}):super(key:key);

  @override
  _LibSbjobsState createState() => _LibSbjobsState();
}

class _LibSbjobsState extends State<LibSbjobs> {
  @override
  ...
  _OnRefresh(){
    ...
    new PinPinReponse().getFilterList(page,sortType,address: cityName,education: filet1,experience: filet2,salary: filet3,jobType: 0,searchText: widget.searchTxt).then((value) {
