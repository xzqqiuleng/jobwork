...
class LibSbBzjob extends StatefulWidget {


  LibSbBzjob({Key key}):super(key:key);

  @override
  _LibSbBzjobState createState() => _LibSbBzjobState();
}

class _LibSbBzjobState extends State<LibSbBzjob> {
  @override
  ...
  _OnRefresh(){
    ...
    new PinPinReponse().getFilterList(page,sortType,address: cityName,education: filet1,experience: filet2,salary: filet3,jobType: 1).then((value) {
