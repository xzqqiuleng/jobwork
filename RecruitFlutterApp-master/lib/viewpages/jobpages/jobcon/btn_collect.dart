...
class BtnCollect extends StatefulWidget {
  final Color themeColor;
  final String title;
  final Function(bool) onValueChanged;

  BtnCollect({Key key,this.themeColor = Colors.black,@required this.title,this.onValueChanged}):super(key:key);
  @override
  _BtnCollectState createState() => _BtnCollectState();
}

class _BtnCollectState extends State<BtnCollect> {
  bool isTap = false;
