...
class CustDialogPhotoSele extends StatelessWidget{
  Function photo_click;
  Function camera_click;
  Function cancle_click;
  CustDialogPhotoSele(this.photo_click,this.camera_click,this.cancle_click);
  @override
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child:  Text("相册",
                      style: TextStyle(
                          fontSize: 16,
                          color: ColorsUtils.black_4B514A
                      ),
