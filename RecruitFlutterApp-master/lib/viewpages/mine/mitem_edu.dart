...
import 'package:recruit_app/viewmodel/edudata_me.dart';


class MineItemEdu extends StatelessWidget {
  final MeEduBean eduData;
  final int index;

  const MineItemEdu({Key key, this.eduData, this.index}) : super(key: key);
