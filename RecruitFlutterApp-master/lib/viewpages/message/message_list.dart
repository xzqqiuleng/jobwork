...
import 'package:recruit_app/cuswidget/cuswidget_badget.dart';
                        ...
                        return GestureDetector(
                          ...
                          child: MessageNotiItem(
                            ...
                            content: idx % 2 == 0
                                ...
                                : '您好，请问有什么可以为您服务的吗？',
                            imgPath: idx % 2 == 0
                                ? 'images/pp_img_notify_blue.png'
                                : 'images/pp_img_service_blue.png',
                          ),
                          onTap: () {
                            if(idx%2==0){
                              Navigator.push(context, MaterialPageRoute(builder: (context)=>MessageNotify()));
                            }else {
                              Navigator.push(context, MaterialPageRoute(builder: (context)=>ChatService()));
                            }
                          },
                        );
                      }
