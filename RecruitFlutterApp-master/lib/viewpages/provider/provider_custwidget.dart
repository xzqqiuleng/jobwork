...
///
/// 方便数据初始化
class ProviderCustWidget<T extends ChangeNotifier> extends StatefulWidget {
  ...
  _ProviderCustWidgetState<T> createState() => _ProviderCustWidgetState<T>();
}

class _ProviderCustWidgetState<T extends ChangeNotifier>
    extends State<ProviderCustWidget<T>> {
  T model;
