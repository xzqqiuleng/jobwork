...
class MessageResume extends StatefulWidget{
  int type;
  MessageResume(this.type);
...
class _JobState extends State<MessageResume>{
 ...
 String title="";
  _OnRefresh(){
    ...
    new PinPinReponse().getFilterJlList(page,searchType: widget.type).then((value) {
...
class EmployeeRowItem extends StatelessWidget {
  ...
  Widget _getrihgt(){
    switch(type){
      ...
      case 3:
        return Image.asset("images/pp_work_new.png",width: 20,height: 20,);
    }
  }
  @override
  Widget build(BuildContext context) {
