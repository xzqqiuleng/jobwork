...
class ItemJobFIlt extends StatelessWidget {
  final JobFiltsBean jobFilterData;
  final int index;
  final bool lastItem;
  final Function(JobFilteSubBean) onTap;

  const ItemJobFIlt({Key key, this.jobFilterData, this.index, this.lastItem=false,this.onTap})
      : super(key: key);
