...
class CustIndict extends StatelessWidget {
  ...
  CustIndict({Key key,this.size,this.currentIndex,this.show = true,this.showBackgroud =false, this.indicatorNormal,this.indicatorSelected,this.indicatorMargin = 5.0,this.paddingBottom = 10, this.type =IndicatorType.circle}): super(key:key);
