...
class CustNewsBanner extends StatefulWidget {
  final double height;
  final double width;
  final int delayTime;
  ...
  CustNewsBanner({Key key,@required this.content,this.width = 240,this.height = 60,this.delayTime = 3,this.scrollTime = 500,this.autoPlay = false}):super(key:key);
  @override
  _CustNewsBannerState createState() => _CustNewsBannerState();
}

class _CustNewsBannerState extends State<CustNewsBanner> {
