...
import 'provider_custwidget.dart';
import 'provider_updatemodel.dart';
import 'btn_progindicto.dart';


class BtnCustUpdate extends StatelessWidget {
...
Future checkAppUpdate(BuildContext context) async {
  ...
  BeanUpdate appUpdateInfo = await ProviderUpdateModel().checkUpdate();
  if (appUpdateInfo?.buildHaveNewVersion ?? false) {
...
/// App更新提示框
showUpdateAlertDialog(context, BeanUpdate appUpdateInfo) async {
    ...
    if (!forceUpdate){
      return  Align(
        ...
        child:  GestureDetector(
          ...
          child: Icon(Icons.close,color: ColorsUtils.black_1e211c) ,
        ),
      );
    }else{
      return Text("");
...
//
                ...
                Text(
                  "更新版本",
                  style: TextStyle(
                      color: ColorsUtils.black_1e211c,
...
Future downloadApp(BuildContext context, BeanUpdate appUpdateInfo) async {
