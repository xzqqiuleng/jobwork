...
class PageJobDetail extends StatefulWidget {
  int id;
  PageJobDetail(this.id);
  @override
  _PageJobDetailState createState() {
    // TODO: implement createState
    return _PageJobDetailState();
  }
}
...
class _PageJobDetailState extends State<PageJobDetail> {
 ...
 List<String> tip = new List();
  _saveByType(int type,int classStr){
    ...
    params["type"] = type;
    new PinPinReponse().saveJobByType(params).then((value) {
 ...
 if(widget.id == null){
   widget.id = 113546932;
    ...
    new PinPinReponse().getJobDetail(widget.id,SharepreferUtils.getUser().userMail).then((value) {
            ...
            IconButton(
                ...
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => PageJub(1,widget.id.toString())));
                })
          ],
        ),
        body: Column(
                              ...
                              GestureDetector(
                                ...
                                child: Row(
                                  ...
                                  children: <Widget>[
                                    ClipRRect(
                                      ...
                                      child: Image.network(
                                          (infors == null|| !infors["company_img"].toString().contains("http"))?UrlConstant.deault_compay:infors["company_img"],
                                          width: 50,
                                          height: 50,
                                          fit: BoxFit.cover),
                                    ),
                                ...
                                onTap: () {
                                  ...
                                  Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                          builder: (context) => PageCompDetail(int.parse(infors["com_id"].toString().trim()))));
                                },
                              ),
                              SizedBox(
                                height: 16,
                          ...
                          return GestureDetector(
                              ...
                              onTap: () {
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => PageJobDetail(datalist[index]["job_id"]),
                                    ));
                              });
                        }
                        return null;
                  ...
                  child: MaterialButton(
                    ...
                    onPressed: () {
                      ...
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => PageChatLine(head_icon: userImg,title: user=="HR发布"?company:user,reply_id: replayId,type: 1,user_id: SharepreferUtils.getUser().userId,)));
                    },
    ...
    if(imgUrl.contains("http")){
      ...
      return Container(
        ...
        decoration: BoxDecoration(
            ...
            color:ColorsUtils.slRandomColor()
        ),
        child: Text(
          imgUrl,
          style: TextStyle(
            ...
            children: <Widget>[
              ...
              Offstage(
                  ...
                  child : Container(
                    ...
                    child: Row(
                      ...
                      mainAxisSize: MainAxisSize.min,
                      children: <Widget>[
                        Image.asset("images/pp_ji.png",height: 16,width: 16,),
                        SizedBox(width: 6,),
                        Text(
                          "2020-07-12前停止招聘",
                          style: TextStyle(
              ...
              Offstage(
                  ...
                  child : Container(
                    ...
                    padding: EdgeInsets.fromLTRB(10, 4, 10, 4),
                    decoration: BoxDecoration(
                      color: ColorsUtils.blue_main.withOpacity(0.2),
                    ...
                    child: Row(
                      ...
                      mainAxisSize: MainAxisSize.min,
                      children: <Widget>[
                        Image.asset("images/pp_bz.png",height: 16,width: 16,),
                        SizedBox(width: 6,),
                        Text(
                          "官方保障，24小时跟踪！",
                          style: TextStyle(
                              color: ColorsUtils.blue_main,
                              fontWeight: FontWeight.bold
                          ),
                        )
                      ],
