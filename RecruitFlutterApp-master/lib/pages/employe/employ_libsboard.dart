...
import 'package:recruit_app/pages/employe/employ_select.dart';
import 'package:recruit_app/pages/employe/employee_detail.dart';
import 'package:recruit_app/pages/jobs/all/citys_select.dart';
import 'package:recruit_app/pages/jobs/all/job_select.dart';
import 'package:recruit_app/pages/jobs/all/job_sort.dart';
import 'package:recruit_app/pages/jobs/all/job_tabbar.dart';
import 'package:recruit_app/pages/service/mivice_repository.dart';
import 'package:recruit_app/pages/share_helper.dart';
import 'package:recruit_app/pages/utils/screen.dart';

import 'employe_row_item.dart';




class EmployLibsboard extends StatefulWidget {

  String searchTxt;
  EmployLibsboard({Key key,this.searchTxt}):super(key:key);

  @override
  _EmployLibsboardState createState() => _EmployLibsboardState();
}

class _EmployLibsboardState extends State<EmployLibsboard> {
  @override
  ...
  _OnRefresh(){
    ...
    new MiviceRepository().getFilterJlList(page,jobType:sortType,address: cityName,education: filet1,sex: filet2,salary: filet3,searchText: widget.searchTxt).then((value) {
  ...
  Widget _buildPopContent() {
    ...
    switch (popType) {
      ...
      case TabbarPopType.popSelectType:
        return EmployTypeSelect(height: contentHeight + kToolbarHeight,
