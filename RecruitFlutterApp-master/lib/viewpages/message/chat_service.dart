...
class ChatService extends StatefulWidget {
  @override
  _ChatServiceState createState() {
    // TODO: implement createState
    return _ChatServiceState();
  }
}

class _ChatServiceState extends State<ChatService> {
  List<ChatBean> _chatList = DataChat.loadChats();
                ...
                children: <Widget>[
                  Expanded(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: <Widget>[
                        Image.asset('images/pp_img_tel_gray.png',
                  ...
                  Expanded(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: <Widget>[
                        Image.asset('images/pp_img_wechat_gray.png',
                  ...
                  Expanded(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: <Widget>[
                        Image.asset('images/pp_img_email_gray.png',
