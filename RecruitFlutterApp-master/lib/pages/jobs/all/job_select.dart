...
import 'package:recruit_app/pages/jobs/all/check.dart';
import 'package:recruit_app/pages/utils/screen.dart';

import 'collection_button.dart';
import 'companytypes_model.dart';
...
class JobTypeSelect extends StatefulWidget {
  ...
  @override
  _JobTypeSelectState createState() => _JobTypeSelectState();
}
                    ...
                    children: typesModel.other.map( (text) {
                      return new Container(
                        ...
                        child: new Row(
                          mainAxisAlignment: MainAxisAlignment.start,
                          children: <Widget>[
                            CustomCheck(normalIcon: "images/icon_check_normal_17x17_@3x.png",
                              checkIcon: "images/icon_check_press_17x17_@3x.png",
                              size: 18,
