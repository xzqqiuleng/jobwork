...
import 'package:recruit_app/viewpages/jobpages/ritem_jobs.dart';
import 'package:recruit_app/viewpages/jobpages/search_compyjobs.dart';

import 'filt_citysss.dart';
import 'filt_jober.dart';

class ListDataJob extends StatefulWidget {

  @override
  _ListDataJobState createState() {
    // TODO: implement createState
    return _ListDataJobState();
  }
}
...
class _JobBodyListState extends State<JobBodyList> with AutomaticKeepAliveClientMixin{
  ...
  void _eventSub(){
    _eventChangeSub= eventBus.on<CitySelEvent>().listen((event) {
  ...
  _OnRefresh(){
    ...
    new PinPinReponse().getWorkList(page,widget.type,address: city).then((value) {
...
class _ListDataJobState extends State<ListDataJob> with SingleTickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      child: Row(
        ...
        children: <Widget>[
          Image.asset(
            'images/pp_img_job_location.png',
          ...
          GestureDetector(
            behavior: HitTestBehavior.opaque,
            onTap: () {
              Navigator.push(context,MaterialPageRoute(builder: (context)=>SearchCompanyJobs(searchType: SearchType.job,)));
            },
            child: Container(
                        ...
                        return Card(
                          ...
                          child: ClipRRect(
                            ...
                            child: FadeInImage.assetNetwork(
                              placeholder: "images/pp_img_job_ad.png",
                              image: "",
                              fit: BoxFit.cover,
                            ),
...
//                    right: ScreenUtil().setWidth(10)),
                ...
                isScrollable: false,
                labelColor: ColorsUtils.app_main,
                labelStyle: TextStyle(
