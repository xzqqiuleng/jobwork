...
import 'package:recruit_app/viewmodel/worslist_me.dart';


class MineItemWork extends StatelessWidget {
  final WorkMeBean workData;
  final int index;

  const MineItemWork({Key key, this.workData, this.index}) : super(key: key);
