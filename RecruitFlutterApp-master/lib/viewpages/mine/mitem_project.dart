...
import 'package:recruit_app/viewmodel/projieldata_me.dart';


class MineItemProject extends StatelessWidget {
  final ProjectMineBean projectData;
  final int index;

  const MineItemProject({Key key, this.projectData, this.index}) : super(key: key);
